...
export default (origin, radius) => ({
    ...
    bar1X1:           origin - radius * 0.55,
    bar1X2:           origin,
    bar1X3:           origin + radius * 0.55,
    bar1Y1:           origin,
    bar1Y2:           origin,
    bar1Y3:           origin,
    bar1Opacity:      1,
    ...
    spark1X2:         origin + radius * 0.7,
    spark1Y1:         origin - radius * 0.3,
    spark1Y2:         origin,
    spark1Opacity:    0,
    spark1Rotation:   0,

    spark2X1:         origin + radius * 0.7,
    spark2X2:         origin + radius * 0.3,
    spark2Y1:         origin,
    spark2Y2:         origin + radius * 0.3,
    spark2Opacity:    0,
    spark2Rotation:   0,

    spark3X1:         origin - radius * 0.7,
    spark3X2:         origin - radius * 0.3,
    spark3Y1:         origin,
    spark3Y2:         origin + radius * 0.3,
    spark3Opacity:    0,
    spark3Rotation:   0,
})
